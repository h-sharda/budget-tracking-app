      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            screenshot: [
              "https://budget-tracker-x.vercel.app/screenshots/dashboard-overview.png",
              "https://budget-tracker-x.vercel.app/screenshots/dashboard-monthly.png",
              "https://budget-tracker-x.vercel.app/screenshots/dashboard-range.png",
              "https://budget-tracker-x.vercel.app/screenshots/profile.png",
            ],
            author: {
              "@type": "Person",
              name: "Harshit Sharda",
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-indigo-100 border border-indigo-200">
                ...
                <p className="text-gray-600">
                  Beautiful charts and graphs that make it easy to understand
                  your spending patterns and financial trends at a glance.
                </p>
              </div>
